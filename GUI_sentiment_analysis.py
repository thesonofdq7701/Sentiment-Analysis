...
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
reviews_df_raw = pd.read_csv("dataset/2_Reviews.csv")
restaurants_df_raw = pd.read_csv("dataset/1_Restaurants.csv")
reviews_df = pd.read_csv("dataset/processed_reviews.csv")
